...
in the future depending on the actual content._
...
1. Such a collection, in the most basic form, could be a list;
in a more sophisticated form, it could be a database - it would be very
...
However, there are attempts to have blogposts, wiki lists, etc.
...
This material can then be easily adapted (forked) and complemented by
...
can be easily crowd-sourced (see for example http://software-carpentry.org/lessons/).
...
to see how and where! We expect all participants to follow our [Code of Conduct](https://github.com/OKScienceDE/Open_Science_101/blob/master/CODE_OF_CONDUCT.md).
